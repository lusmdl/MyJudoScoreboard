...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow), board(nullptr) {
    ...
    // QTimer initialisieren und starten, um mainLoop() alle 100 Millisekunden aufzurufen
    connect(&mainTimer, &QTimer::timeout, this, &MainWindow::mainLoop);
...
void MainWindow::mainLoop() {
    ...
    // Diese Methode wird alle 100 Millisekunden aufgerufen
    // Fügen Sie hier Ihren Code ein, der alle 100 Millisekunden ausgeführt werden soll

    //qDebug() << "MainWindow::mainLoop()";
